...
{\small Pablo Jaramillo Palacio - 11-B}
\end{center}
\ruleline

\begin{center}
\scorebox{2.09/5.00}{Resultado técnico provisional}\hfill
\scorebox{42\%}{Avance frente a la rúbrica}
\end{center}
\statusbox{Proyecto principal}{Registro de actividades}
\statusbox{Repositorio y versión}{pablitojarita2008-oss/pablitoSeminario - commit 5b8125d}
\statusbox{Nivel actual}{Básico}
...
\midrule
HTML y estructura & 15\% & 2.8 & 2.8 & 0.0 \\
JavaScript y lógica & 20\% & 1.8 & 1.8 & 0.0 \\
DOM, funciones y eventos & 15\% & 1.4 & 1.4 & 0.0 \\
CSS y presentación & 15\% & 0.0 & 0.0 & 0.0 \\
Navegación y persistencia & 10\% & 4.0 & 4.0 & 0.0 \\
Validación y errores & 10\% & 3.2 & 3.2 & 0.0 \\
Integración funcional & 10\% & 3.4 & 3.4 & 0.0 \\
...
\begin{itemize}
\item Navegación y persistencia: Persistencia con localStorage o sessionStorage
\item Navegación y persistencia: Navegación programática entre páginas
\item Navegación y persistencia: Proyecto multipágina
...
\begin{itemize}
\item HTML y estructura: 2 página(s) HTML prácticamente vacías
\item JavaScript y lógica: Dependencia de prompt() en 7 puntos
...
\begin{itemize}
\item Integrante A: formulario, resumen y CSS.
\item Integrante B: objeto registro, validación y localStorage.
\item Ambos: edición, README y commits identificables.
\end{itemize}

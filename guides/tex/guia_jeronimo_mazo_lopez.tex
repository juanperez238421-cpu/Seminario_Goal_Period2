...
{\small Jerónimo Mazo López - 11-A}
\end{center}
\ruleline
...
\end{center}
\statusbox{Proyecto principal}{Sistema de registro estudiantil}
...
\begin{enumerate}
\item Crear o identificar un repositorio público del proyecto.
\item Subir index.html, styles.css, script.js y README.md.
\item Construir un formulario con nombre, grupo, correo y actividad.
\item Validar campos y mostrar un resumen con DOM.
\item Guardar y recuperar un registro con localStorage.
\item Realizar al menos tres commits descriptivos.
\end{enumerate}

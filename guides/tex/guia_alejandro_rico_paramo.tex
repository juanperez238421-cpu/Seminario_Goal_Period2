...
{\small Alejandro Rico Páramo - 11-B}
\end{center}
\ruleline
...
\end{center}
\statusbox{Proyecto principal}{Gestor de tareas académicas}
...
\begin{enumerate}
\item Crear o vincular el repositorio del gestor de tareas.
\item Crear formulario para título, materia, fecha y prioridad.
\item Modelar tareas como objetos dentro de un arreglo.
\item Renderizar, completar, filtrar y eliminar tareas con DOM.
\item Persistir el arreglo en localStorage usando JSON.

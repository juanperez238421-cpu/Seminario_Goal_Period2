...
{\small Tomás González Giraldo - 11-C}
\end{center}
\ruleline
...
\end{center}
\statusbox{Proyecto principal}{Sistema de inventario escolar}
...
\begin{enumerate}
\item Crear o vincular el repositorio del inventario.
\item Registrar producto, categoría, cantidad y movimiento.
\item Validar números enteros y evitar existencias negativas.
\item Renderizar una tabla de inventario y actualizarla con DOM.
\item Guardar el inventario con JSON en localStorage.

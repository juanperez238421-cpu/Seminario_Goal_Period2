...
{\small Samuel Chavarriaga Avendaño - 11-B}
\end{center}
\ruleline
...
\end{center}
\statusbox{Proyecto principal}{Formulario multipágina con persistencia}
...
\begin{enumerate}
\item Confirmar si trabajará individualmente o en pareja y registrar el repositorio compartido.
\item Crear dos páginas conectadas: formulario y resumen.
\item Validar entradas antes de continuar.
\item Guardar un objeto con JSON en localStorage y recuperarlo.
\item Agregar botón editar o volver y CSS responsive.
\item Dejar commits propios o una distribución de roles verificable.
\end{enumerate}

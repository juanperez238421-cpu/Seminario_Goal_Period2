...
{\small Juan Pablo Arango Giraldo - 11-A}
\end{center}
\ruleline

\begin{center}
\scorebox{2.11/5.00}{Resultado técnico provisional}\hfill
\scorebox{42\%}{Avance frente a la rúbrica}
\end{center}
\statusbox{Proyecto principal}{Sistema de pedidos Delivery}
\statusbox{Repositorio y versión}{jp0705git/SeminarioProgramacion2 - commit 0245023}
...
JavaScript y lógica & 20\% & 2.3 & 2.3 & 0.0 \\
...
Git y documentación & 5\% & 0.0 & 0.0 & 0.0 \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{itemize}
\item HTML y estructura: 5 página(s) HTML prácticamente vacías
\item JavaScript y lógica: Dependencia de prompt() en 6 puntos
...
\begin{itemize}
\item Integrante A: catálogo, formulario y CSS.
\item Integrante B: datos, cálculo, DOM y persistencia.
